  ...
  return (
    <PageTransition>
      ...
      <div className="contact-container grid grid-cols-12 px-[30px] py-[50px] md:px-[50px] md:py-[80px] lg:p-[200px]">
        <div className="col-span-12 md:col-span-4 space-y-[20px] md:space-y-[40px]">
          <h3 className="text-dark text-center md:text-start md:text-[30px] lg:text-[38px] font-playfair tracking-widest">
            Contact Detail
          </h3>
          <p className="text-dark font-roboto text-[14px] lg:text-[22px] tracking-wide">
            Feel free to use the form or drop us an email,
            <br className="hidden md:block" /> Old-fashioned phone calls work
            too.
          </p>
          <div className="contact-info text-center md:text-start space-y-[10px] md:space-y-[20px] text-gray font-roboto text-[14px] lg:text-[26px] tracking-wide">
            <p>039 8185 925</p>
        ...
        <div className="col-span-12 md:col-span-8 md:pl-[180px]">
