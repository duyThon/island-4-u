...
const About = () => {
  return (
    <>
      ...
      <div className="about-container p-[100px]">
        ...
        <div className="grid grid-cols-2 gap-[80px]">
          <div className="col-span-2 md:col-span-1 space-y-[60px]">
          ...
          <div className="col-span-2 md:col-span-1 space-x-[60px] grid grid-cols-2">
            <div className="space-y-[40px]">
              <p className="text-gray font-roboto text-[12px] lg:text-[20px] tracking-wider">
                <span className="drop-cap text-dark font-playfair text-[40px] lg:text-[60px] leading-none">
                  L
                </span>
        ...
        <div className="py-[60px] pt-[100px] space-y-[30px]">
        ...
        <div className="grid grid-cols-12 px-[100px]">
          <div className="md:col-span-7  md:w-5/6 pl-[100px] col-span-1 space-y-[20px]">
            <div className="text-gray text-[26px] lg:text-[36px] font-playfair tracking-wider leading-none capitalize">
          ...
          <div className="md:col-span-5 col-span-1 space-x-[60px]">
            <div className="space-x-[60px] flex">
              <div className=" border-l-2 border-[#d7b184] w-0 h-[300px] mt-[80px]"></div>
              <div className="space-y-[30px]">
                <h3 className="text-gray md:text-[16px] lg:text-[20px] font-playfair tracking-wide lg:font-bold capitalize">
                  our core values
                </h3>
                <div className="space-y-[30px]">
                  <div className="text-dark text-[26px] lg:text-[36px] font-playfair tracking-wider leading-none capitalize">
                    AUTHENTICITY
                  </div>
                  <div className="text-dark text-[26px] lg:text-[36px] font-playfair tracking-wider leading-none capitalize">
                    PROFESSIONALISM
      ...
      <div className=" w-screen h-[390px] overflow-hidden relative">
        <img src={img2} className="w-full h-full object-cover" />
        <div className="absolute inset-0 bg-black bg-opacity-40" />
        <div className="absolute inset-y-0 left-[100px] right-[100px] flex items-center justify-center text-white text-[40px] lg:text-[60px] font-playfair leading-none">
          <div className="flex items-center justify-between w-full">
            <h2 className="">
              Making memories: island owner <br /> experiences to remember
            </h2>
      ...
      <div className="w-screen px-[30px] py-[50px] md:px-[50px] md:py-[80px] lg:p-[100px]">
        <h2 className="text-dark text-[40px] lg:text-[60px] font-playfair tracking-wide leading-none text-center">
          Leave A Message
        </h2>
        <div className="grid grid-cols-12 space-y-[40px]">
          ...
          <div className="col-span-12 md:col-span-10 lg:col-span-6 space-y-[40px]">
            <div className="grid grid-cols-2 gap-[40px]">
              <input
                className="section6-input col-span-1"
