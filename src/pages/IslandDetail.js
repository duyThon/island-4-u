  ...
  return (
    <>
      <div className="h-[60vh] overflow-hidden relative">
        ...
        <div className="absolute bottom-[100px] left-1/2 -translate-x-1/2 text-white">
          <svg
      ...
      <div className="island-detail-container p-[100px] grid grid-cols-12 gap-[40px]">
        <div className="col-span-12 md:col-span-5 lg:col-span-4 relative">
          <div className="grid grid-cols-3 md:sticky md:top-[150px]">
            <div className="col-span-1 text-dark text-[24px] font-roboto space-y-[10px]">
              <p>Location</p>
              <p>Price</p>
              <p>Area</p>
              <p>Services</p>
            </div>
            <div className="col-span-2 text-[24px] text-gray font-roboto space-y-[10px]">
              <p>{island.location}</p>
              <p>
              ...
              <ul className="list-none text-[24px] flex flex-wrap gap-1 pt-[10px]">
        ...
        <div className="col-span-12 md:col-span-7 lg:col-span-8">
          ...
          <h2 className="text-dark text-[60px] font-playfair tracking-wide leading-none mb-[20px]">
            {island.name}
          </h2>
          ...
          <div className="col-span-12 md:col-span-10 lg:col-span-6 space-y-[40px]">
            ...
            <div className="w-full flex items-center justify-between">
              <div className="space-x-[10px] flex">
                ...
                <p className="text-gray text-[20px] font-roboto">
                  I agree to the{" "}
      ...
      <div className="w-full p-[100px] bg-white">
        <h2 className="text-dark text-[40px] lg:text-[60px] font-playfair tracking-wide leading-none text-center">
          Other Islands You May Be Interested In
        </h2>
        <div className="flex justify-center gap-[40px] my-[40px] font-roboto text-[24px]">
          <button
