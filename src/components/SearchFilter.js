          ...
          >
            ...
            <div className="flex justify-between gap-4 mt-6">
              <button
                ...
                className="w-1/2 border font-roboto text-[14px] text-gray cursor-pointer hover:text-red flex items-center justify-center group"
              >
                <svg
                  className="fill-gray group-hover:fill-red mr-[8px]"
              ...
              <button
                ...
                className="w-1/2 font-roboto text-[14px] bg-red text-white py-2 shadow hover:bg-opacity-90"
              >
                Search
              </button>
            </div>
