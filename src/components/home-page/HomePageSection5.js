...
export default function Testimonials() {
  ...
  return (
    <div className="relative w-full">
      <div className="hidden lg:block md:h-[300px] lg:h-[800px]">
        <img
          src={bg}
      ...
      <div className="grid grid-cols-12 bg-white px-[30px] py-[50px] md:px-[50px] md:py-[80px] lg:p-[100px] lg:pl-[200px]">
        {/* LEFT: Description */}
        <div className="col-span-12 md:col-span-6 flex items-center md:items-start flex-col">
          <h2 className="text-[30px] lg:text-[60px] text-center md:text-start font-playfair tracking-wider leading-none">
            Your Dream
            <br /> Getaway Awaits.
          </h2>
          <p className="text-[12px] lg:text-[20px] leading-[2] font-playfair p-0 pt-[20px] md:pr-[40px] lg:pt-[40px] lg:pr-[100px] lg:pr-[200px] tracking-wide">
        ...
        {/* RIGHT: Testimonials */}
        <div className="absolute top-[40px] md:-top-[100px] lg:-top-[200px] col-span-12 md:col-span-6 lg:col-span-4 text-white bg-primary p-[20px] md:p-[30px] lg:p-[50px] shadow-md relative overflow-hidden flex flex-col justify-center items-center">
          <h2 className="text-[28px] md:text-[40px] font-playfair tracking-wider leading-none">
            TESTIMONIALS
          </h2>
          <img
            className="section5-logo w-[150px] m-[40px] lg:w-[300px] md:w-[200px] md:m-[50px] lg:m-[80px]"
            src={logo}
          />
          <Swiper
          ...
          >
            {testimonials.map((review, index) => (
              <SwiperSlide key={index}>
                ...
                >
                  <p className="text-white text-[14px] lg:text-[22px] italic mx-[40px] lg:mx-[60px] text-center">
                    "{review.text}"
                  </p>
                  <p className="text-white text-[12px] lg:text-[20px] italic m-[40px] lg:m-[60px] text-end">
                    — {review.name}
                  </p>
                </div>
              </SwiperSlide>
